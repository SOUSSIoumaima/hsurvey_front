...
import { X, Edit3, User, Mail } from 'lucide-react';
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-1">
              Update user information for <span className="font-semibold text-gray-800">{user.username}</span>
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                ...
                required
                className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white text-gray-800 font-medium transition-all duration-200 hover:border-green-300"
          ...
          <div className="flex gap-4 pt-4">
            ...
            <Button
              ...
              loading={loading}
              label="Save Changes"
              className="flex-1 py-3 text-base font-medium bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 transition-all duration-200 transform hover:scale-[1.02] shadow-lg hover:shadow-xl"
            />
          </div>
        </form>
      </div>
